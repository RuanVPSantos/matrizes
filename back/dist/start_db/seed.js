...
async function main() {
    ...
    // Create admin user
    const adminPassword = await auth_1.Auth.hashPassword("admin123");
    ...
    // Create regular user
    const userPassword = await auth_1.Auth.hashPassword("user123");
    ...
    await prisma.bloco.upsert({
        ...
        update: {},
        create: {
            type: client_1.BlocoType.IMAGEM,
            order: 3,
            content: {
